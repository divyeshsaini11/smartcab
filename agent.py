...
class LearningAgent(Agent):
    ...
    def __init__(self, env, learning=False, epsilon=1.0, alpha=0.5):
        ...
        #self.Q = { waypoint : {'left':0.0,'right':0.0,'forward':0.0},
        #           light : {'green':0.0, 'red':0.0},
        #           left : {'none':0.0, 'left':0.0, 'forward':0.0},
        #           right : {'none':0.0, 'left':0.0, 'forward':0.0 },
        #           oncoming : {'none':0.0, 'left':0.0, 'forward':0.0}   
        #            }
        self.Q = dict()
    ...
    def reset(self, destination=None, testing=False):
        ...
        if testing is True:
            ...
            self.epsilon = math.exp(-1*float(self.a*self.total_trials))
    ...
    def choose_action(self, state):
        ...
        #   Otherwise, choose an action with the highest Q-value for the current state
            ...
            if random_action >= 1 - self.epsilon:
                action = random.choice(self.valid_actions)
            else:
                for actions in self.valid_actions:
                    if self.Q[self.state][actions] == self.get_maxQ(self.state):
